    ...
    <section id="cta" className="py-24 bg-navy text-primary-foreground">
      <div className="max-w-3xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="mailto:arisandcompany@icloud.com?subject=Quote%20Request" className="px-8 py-3.5 rounded-lg bg-primary-foreground text-navy font-semibold text-lg hover:bg-primary-foreground/90 transition shadow-lg">
            Request a Quote
          </a>
