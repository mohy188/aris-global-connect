...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <img src={heroBg} alt="" className="absolute inset-0 w-full h-full object-cover grayscale" width={1920} height={1080} />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center py-32">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-primary-foreground leading-tight animate-fade-up">
          Connecting Buyers with Trusted Suppliers <span className="text-primary-foreground">Worldwide</span>
        </h1>
        <p className="mt-6 text-lg sm:text-xl text-primary-foreground/70 max-w-2xl mx-auto animate-fade-up animate-delay-200">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center animate-fade-up animate-delay-300">
          <a href="#cta" className="px-8 py-3.5 rounded-lg bg-primary-foreground text-navy font-semibold text-lg hover:bg-primary-foreground/90 transition shadow-lg">
            Get Started
          </a>
