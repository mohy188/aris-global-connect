    ...
    <section id="industries" className="py-24 bg-background">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <p className="text-sm font-semibold uppercase tracking-widest text-gold mb-3">Industries We Serve</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground">We proudly serve a wide range of industries</h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {industries.map((ind) => (
            <div key={ind.label} className="flex flex-col items-center text-center bg-card rounded-2xl p-6 border border-border hover:border-gold/40 transition-colors">
